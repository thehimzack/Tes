			...
			<div class="card shadow-custom border-0">
             ...
             <div class="row mb-3">
              ...
              <div class="col-sm-10">
                ...
                <p class="d-block m-0">
                  <span class="me-1 text-muted">/usr/bin/ffprobe</span>
                </p>
              </div>
            </div>
             ...
             <div class="row mb-3">
              <label class="col-sm-2 col-form-labe text-lg-end">Coconut® Region</label>
              <div class="col-sm-10">
                 <select name="coconut_region" class="form-select">
                 <option @selected($settings->coconut_region == 'Virginia') value="Virginia">North Virginia (USA)</option>
                 <option @selected($settings->coconut_region == 'Oregon') value="Oregon">Oregon (USA)</option>
                 <option @selected($settings->coconut_region == 'Ireland') value="Ireland">Ireland (Europe)</option>
                 </select>
              </div>
           </div>
